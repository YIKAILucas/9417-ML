...
# YUCHENG LU takes charge of this final MLP model with activation='tanh', 'hidden_layer_sizes'=(100,), 'alpha'=0.0001
# this code will take about 2 minutes to run it
...
for category in trainClassification:
    ...
    if numOfClass > 1 and numOfOne > 5 and numOfZero > 5:
        finalCLF = MLPClassifier(activation='tanh', hidden_layer_sizes=(100,), alpha=0.0001)
